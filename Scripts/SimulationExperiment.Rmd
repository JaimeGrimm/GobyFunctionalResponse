...
```{r}
colours = c("red3", "orange", "gold", "lightgreen", "forestgreen", "lightblue", "navy", "purple3", "orchid", "pink")
j <- c(1, 101, 201, 301, 401, 501, 601, 701, 801, 901)
  
## Experiment 1
N0s <- c(4, 6, 10, 20, 60, 90, 120); N0sRep <- rep(N0s, each = 100) 
# Low, II
Ex1.LowII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex1.Low.II.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex1.Low.II.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex1.Low.II.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex1.Low.II.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex1.Low.II.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex1.Low.II.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex1.Low.II.Unif.Props[j[i]:(j[i] + 99), 7])
...
plot(1, type = "n", xlim = c(0, 120), ylim = c(0, 1), 
     main = "Ex1.LowII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex1.LowII.Lowess[[i]], col = colours[i])
}
# Med., II
Ex1.MedII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex1.Med.II.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex1.Med.II.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex1.Med.II.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex1.Med.II.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex1.Med.II.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex1.Med.II.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex1.Med.II.Unif.Props[j[i]:(j[i] + 99), 7])
  # Ex1.MedII.Lowess[[i]] <- lowess(N0sRep, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0sRep)))
  Ex1.MedII.Lowess[[i]] <- lowess(N0sRep, Props)
}
plot(1, type = "n", xlim = c(0, 120), ylim = c(0, 1), 
     main = "Ex1.MedII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex1.MedII.Lowess[[i]], col = colours[i])
}
# Med., III
Ex1.MedIII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex1.Med.III.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex1.Med.III.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex1.Med.III.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex1.Med.III.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex1.Med.III.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex1.Med.III.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex1.Med.III.Unif.Props[j[i]:(j[i] + 99), 7])
  # Ex1.MedIII.Lowess[[i]] <- lowess(N0sRep, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0sRep)))
  Ex1.MedIII.Lowess[[i]] <- lowess(N0sRep, Props)
}
plot(1, type = "n", xlim = c(0, 120), ylim = c(0, 1), 
     main = "Ex1.MedIII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex1.MedIII.Lowess[[i]], col = colours[i])
}
# High, II
Ex1.HighII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex1.High.II.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex1.High.II.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex1.High.II.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex1.High.II.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex1.High.II.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex1.High.II.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex1.High.II.Unif.Props[j[i]:(j[i] + 99), 7])
  # Ex1.HighII.Lowess[[i]] <- lowess(N0sRep, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0sRep)))
  Ex1.HighII.Lowess[[i]] <- lowess(N0sRep, Props)
}
plot(1, type = "n", xlim = c(0, 120), ylim = c(0, 1), 
     main = "Ex1.HighII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex1.HighII.Lowess[[i]], col = colours[i])
}
# High, III
Ex1.HighIII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex1.High.III.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex1.High.III.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex1.High.III.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex1.High.III.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex1.High.III.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex1.High.III.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex1.High.III.Unif.Props[j[i]:(j[i] + 99), 7])
...
plot(1, type = "n", xlim = c(0, 120), ylim = c(0, 1), 
     main = "Ex1.HighIII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex1.HighIII.Lowess[[i]], col = colours[i])
}

## Experiment 2
N0s <- c(2, 3, 5, 10, 20, 30, 50); N0sRep <- rep(N0s, each = 100)
# Low, II
Ex2.LowII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex2.Low.II.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex2.Low.II.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex2.Low.II.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex2.Low.II.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex2.Low.II.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex2.Low.II.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex2.Low.II.Unif.Props[j[i]:(j[i] + 99), 7])
...
plot(1, type = "n", xlim = c(0, 50), ylim = c(0, 1), 
     main = "Ex2.LowII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex2.LowII.Lowess[[i]], col = colours[i])
}
# Low, III
Ex2.LowIII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex2.Low.III.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex2.Low.III.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex2.Low.III.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex2.Low.III.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex2.Low.III.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex2.Low.III.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex2.Low.III.Unif.Props[j[i]:(j[i] + 99), 7])
  # Ex2.LowIII.Lowess[[i]] <- lowess(N0sRep, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0sRep)))
  Ex2.LowIII.Lowess[[i]] <- lowess(N0sRep, Props)
}
plot(1, type = "n", xlim = c(0, 50), ylim = c(0, 1), 
     main = "Ex2.LowIII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex2.LowIII.Lowess[[i]], col = colours[i])
}
# Med., III
Ex2.MedIII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex2.Med.III.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex2.Med.III.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex2.Med.III.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex2.Med.III.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex2.Med.III.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex2.Med.III.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex2.Med.III.Unif.Props[j[i]:(j[i] + 99), 7])
  # Ex2.MedIII.Lowess[[i]] <- lowess(N0sRep, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0sRep)))
  Ex2.MedIII.Lowess[[i]] <- lowess(N0sRep, Props)
}
plot(1, type = "n", xlim = c(0, 50), ylim = c(0, 1), 
     main = "Ex2.MedIII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex2.MedIII.Lowess[[i]], col = colours[i])
}
# High, II
Ex2.HighII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex2.High.II.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex2.High.II.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex2.High.II.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex2.High.II.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex2.High.II.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex2.High.II.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex2.High.II.Unif.Props[j[i]:(j[i] + 99), 7])
  # Ex2.HighII.Lowess[[i]] <- lowess(N0sRep, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0sRep)))
  Ex2.HighII.Lowess[[i]] <- lowess(N0sRep, Props)
}
plot(1, type = "n", xlim = c(0, 50), ylim = c(0, 1), 
     main = "Ex2.HighII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex2.HighII.Lowess[[i]], col = colours[i])
}
# High, III
Ex2.HighIII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex2.High.III.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex2.High.III.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex2.High.III.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex2.High.III.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex2.High.III.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex2.High.III.Unif.Props[j[i]:(j[i] + 99), 6], 
             Ex2.High.III.Unif.Props[j[i]:(j[i] + 99), 7])
...
plot(1, type = "n", xlim = c(0, 50), ylim = c(0, 1), 
     main = "Ex2.HighIII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex2.HighIII.Lowess[[i]], col = colours[i])
}

# Experiment 3
N0s <- c(2, 3, 5, 10, 20, 30); N0sRep <- rep(N0s, each = 100)
# Rocks, II
Ex3.RocksII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex3.Rocks.II.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex3.Rocks.II.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex3.Rocks.II.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex3.Rocks.II.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex3.Rocks.II.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex3.Rocks.II.Unif.Props[j[i]:(j[i] + 99), 6])
...
plot(1, type = "n", xlim = c(0, 30), ylim = c(0, 1), 
     main = "Ex3.RocksII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex3.RocksII.Lowess[[i]], col = colours[i])
}
# Sand, II
Ex3.SandII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex3.Sand.II.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex3.Sand.II.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex3.Sand.II.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex3.Sand.II.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex3.Sand.II.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex3.Sand.II.Unif.Props[j[i]:(j[i] + 99), 6])
  # Ex3.SandII.Lowess[[i]] <- lowess(N0sRep, Props, f = 6/6, iter = 3, delta = 0.01 * diff(range(N0sRep)))
  Ex3.SandII.Lowess[[i]] <- lowess(N0sRep, Props)
}
plot(1, type = "n", xlim = c(0, 30), ylim = c(0, 1), 
     main = "Ex3.SandII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
  lines(Ex3.SandII.Lowess[[i]], col = colours[i])
}
# Sand, III
Ex3.SandIII.Lowess <- vector(mode = "list", length = 10)
for (i in 1:10){
  Props <- c(Ex3.Sand.III.Unif.Props[j[i]:(j[i] + 99), 1],
             Ex3.Sand.III.Unif.Props[j[i]:(j[i] + 99), 2], 
             Ex3.Sand.III.Unif.Props[j[i]:(j[i] + 99), 3], 
             Ex3.Sand.III.Unif.Props[j[i]:(j[i] + 99), 4],
             Ex3.Sand.III.Unif.Props[j[i]:(j[i] + 99), 5], 
             Ex3.Sand.III.Unif.Props[j[i]:(j[i] + 99), 6])
...
plot(1, type = "n", xlim = c(0, 30), ylim = c(0, 1), 
     main = "Ex3.SandIII.Lowess", ylab = "Initial Density", xlab = "Proportion")
for (i in 1:10){
...
-   Low, II: 10/10 Correct

-   Med., II: 10/10 Correct

-   Med., III: 0/10 Correct

-   High, II: 10/10 Correct

-   High, III, 0/10 Correct

Experiment 2

-   Low, II: 8/10 Correct

-   Low, III: 3/10 Correct

-   Med., III: 10/10 Correct

-   High, II: 9/10 Correct

-   High, III, 10/10 Correct

Experiment 3

-   Rocks, II: 9/10 Correct

-   Sand, II: 8/10 Correct

-   Sand, III: 1/10 Correct
