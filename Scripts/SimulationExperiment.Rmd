...
for (i in 1:length(Ex1SimDat)){
  ...
  CIH.II.III.NA <- c(length(which(Out.List.Outer[[i]] == "Couldn't invert Hessian")),
...
colnames(Ex1.Prop) <- c("Couldn't Invert Hessian", "II", "III", "No Evidence")
...
colnames(Ex2.Prop) <- c("Couldn't Invert Hessian", "II", "III", "No Evidence")
...
colnames(Ex3.Prop) <- c("Couldn't Invert Hessian", "II", "III", "No Evidence")
...
**TRYING TO WORK OUT THE WARNING: COULDN'T INVERT HESSIAN STUFF**
