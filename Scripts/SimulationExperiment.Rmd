...
N0s <- c(4, 6, 10, 20, 60, 90, 120)
colours <- c("red3", "orange", "gold", "lightgreen", "forestgreen", "lightblue", "navy", "purple3", "orchid")
plot(x = N0s, y = Ex1.Med.II.Unif.Props[1, ],
     type = "l", xlab = "Initial Density", ylab = "Proportion Alive", ylim = c(0, 1))
for (i in 2:10){
  points(x = N0s, y = Ex1.Med.II.Unif.Props[i, ],
         type = "l", col = colours[i - 1])
}
...
N0s <- c(4, 6, 10, 20, 60, 90, 120)
colours <- c("red3", "orange", "gold", "lightgreen", "forestgreen", "lightblue", "navy", "purple3", "orchid")
plot(x = N0s, y = Ex1.Med.III.Unif.Props[1, ],
     type = "l", xlab = "Initial Density", ylab = "Proportion Alive", ylim = c(0, 1))
for (i in 2:10){
  points(x = N0s, y = Ex1.Med.III.Unif.Props[i, ],
         type = "l", col = colours[i - 1])
}

## W/ Lowess smoothing
lowess(dead[dead$treatment=="high.c","density"], prop.dh, f = 10/10, iter = 3, delta = 0.01 * diff(range(dead[dead$treatment=="high.c","density"])))

N0s <- rep(N0s, each = 1000) 

Props <- c(Ex1.Med.III.Unif.Props[ , 1], Ex1.Med.III.Unif.Props[ , 2], Ex1.Med.III.Unif.Props[ , 3], Ex1.Med.III.Unif.Props[ , 4],Ex1.Med.III.Unif.Props[ , 5], Ex1.Med.III.Unif.Props[ , 6], Ex1.Med.III.Unif.Props[ , 7])
temp <- lowess(N0s, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0s)))
plot(temp, type = "l")

Props <- c(Ex1.Med.II.Unif.Props[ , 1], Ex1.Med.II.Unif.Props[ , 2], Ex1.Med.II.Unif.Props[ , 3], Ex1.Med.II.Unif.Props[ , 4],Ex1.Med.II.Unif.Props[ , 5], Ex1.Med.II.Unif.Props[ , 6], Ex1.Med.II.Unif.Props[ , 7])
temp <- lowess(N0s, Props, f = 7/7, iter = 3, delta = 0.01 * diff(range(N0s)))
plot(temp, type = "l")
```
