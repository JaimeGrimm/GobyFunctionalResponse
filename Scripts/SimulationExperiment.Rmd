...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.TLow.II.Unif[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.TMed.II.Unif[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.TMed.II.Norm[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
set.seed(123)
b.vec <- sample(seq(0.218, 1686863.823/100, 0.001), 1000, replace = FALSE) 
c.vec <- sample(seq(0.049, 1796176.396/100, 0.001), 1000, replace = FALSE) 
h.vec <- sample(seq(0.033, 0.06, 0.001), 1000, replace = TRUE)
Ex1.TMed.III.Unif <- vector(mode = 'list', length = length(N0))
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.TMed.III.Unif[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.THigh.II.Unif[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.THigh.II.Norm[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
set.seed(123)
b.vec <- sample(seq(0.079, 1072285.537/100, 0.001), 1000, replace = FALSE) 
c.vec <- sample(seq(0.000, 2227240.993/100, 0.001), 1000, replace = FALSE) 
h.vec <- sample(seq(0.008, 0.088, 0.001), 1000, replace = TRUE)
Ex1.THigh.III.Unif <- vector(mode = 'list', length = length(N0))
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.THigh.III.Unif[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex1.THigh.III.Norm[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.TLow.II.Unif[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.TLow.II.Norm[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
b.vec <- sample(seq(0.062, 197962.2481/100, 0.001), 1000, replace = FALSE) 
c.vec <- sample(seq(0.000, 533631.8351/100, 0.001), 1000, replace = FALSE) 
h.vec <- sample(seq(0.000, 0.143, 0.001), 1000, replace = TRUE)
Ex2.TLow.III.Unif <- vector(mode = 'list', length = length(N0))
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.TLow.III.Unif[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.TLow.III.Norm[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
b.vec <- sample(seq(0.013, 323804.821/100, 0.001), 1000, replace = FALSE) 
c.vec <- sample(seq(0.000, 3514096.291/1000, 0.001), 1000, replace = FALSE) 
h.vec <- sample(seq(0.000, 0.274, 0.001), 1000, replace = TRUE)
Ex2.TMed.III.Unif <- vector(mode = 'list', length = length(N0))
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.TMed.III.Unif[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.TMed.III.Norm[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.THigh.II.Unif[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.THigh.II.Norm[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
c.vec <- sample(seq(0.000, 2.007, 0.001), 1000, replace = FALSE) 
h.vec <- sample(seq(0.000, 0.420, 0.001), 1000, replace = TRUE)
Ex2.THigh.III.Unif <- vector(mode = 'list', length = length(N0))
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.THigh.III.Unif[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex2.THigh.III.Norm[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex3.TRocks.II.Unif[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex3.TRocks.II.Norm[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
a.vec <- sample(seq(0.488, 1.516, 0.001), 1000, replace = FALSE) 
h.vec <- sample(seq(0.000, 0.249, 0.001), 1000, replace = TRUE)
Ex3.TSand.II.Unif <- vector(mode = 'list', length = length(N0))
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex3.TSand.II.Unif[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex3.TSand.II.Norm[[i]][j] <- RogersII(N0[i], a.vec[j], h.vec[j], 2)
  }
}
...
b.vec <- sample(seq(0.221, 3338468.210/100, 0.001), 1000, replace = FALSE) 
c.vec <- sample(seq(0.000, 1780576.771/100, 0.001), 1000, replace = FALSE) 
h.vec <- sample(seq(0.000, 0.289, 0.001), 1000, replace = TRUE)
Ex3.TSand.III.Unif <- vector(mode = 'list', length = length(N0))
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex3.TSand.III.Unif[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
...
for (i in 1:length(N0)){
  for (j in 1:1000){
    Ex3.TSand.III.Norm[[i]][j] <- HassellIII(N0[i], b.vec[j], c.vec[j], h.vec[j], 2)
  }
}
